...
//Lending protocols either mint a collateral token to represent the colateral value of the user's deposit or they create a share to represent the portion of the bank you own
